...
const Upload = ({toast}) => {
    ...
    if (uploading) {
        return (
            <div className="w-screen h-[91vh] absolute text-center bg-black/70 z-20 top-0 left-0 text-white text-3xl">
                Uploading under process please wait... <br /> Do not touch key or
                process may be reverted ...
            </div>
        );
    }
                    ...
                    <div className="flex flex-col gap-y-4">
                        ...
                        <div className="flex flex-col w-full max-md:w-full ">
                            ...
                            <p className="text-gray-500">
                                <span className="text-red-500">*</span>Uplaod videos of size
                                below 100 mb
                            </p>
                        </div>
