...
const PlaylistCard = ({ list }) => {
    ...
    return (
        <div className='w-full h-full'>
            ...
            >
                <div className='w-1/2 h-full  flex flex-col ' onClick={() => navigate(`/playlist/${list._id}`)}>
                ...
                <div className='w-1/2 h-full bg-black/50 text-white flex flex-col justify-center items-center'>
                    ...
                    <button onClick={() => navigate('/')} className='text-gray-500 px-5 py-2 hover:bg-gray-900 rounded-full'>
                        Add new Videos ⊕
                    </button>
                </div>
            </div>
